 ...
 * Date: 2015/11/23
 * Time: 11:45
 * User：Redis 操作，支持 Master/Slave 的负载集群
 */
class RedisClient
{
    ...
    /**
     * @param $key string $key 缓存KEY,支持一次取多个 $key = array('key1','key2')
     * @param bool $isArray 是否是数组，是的话就返回 反序列化结果
     * @return mixed 失败返回 false, 成功返回字符串或数组
     */
